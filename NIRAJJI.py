...
TOKEN = '7802187107:AAFjlwTP3UDD_f7dnNrPLQCuDY44VoRyEbo'
MONGO_URI = 'mongodb+srv://BAWA:<db_password>@cluster0.axdrj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002473347530
CHANNEL_ID = -1002473347530
error_channel_id = -1002473347530
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @ITS_BAWA.*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner:@ITS_BAWA* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance:@ITS_BAWA* 🙏"  # Contact owner message
    else:
